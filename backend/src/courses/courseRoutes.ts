...
export async function ensureSchema(server: FastifyInstance) {
    const migrations = [
        ...
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS common_mistakes_json JSONB`,
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS self_check_questions_json JSONB`,
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS homework_json JSONB`,
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS quiz_json JSONB`,
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS lesson_pages_json JSONB`,
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS lesson_steps_json JSONB`,
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS visual_blocks_json JSONB`,
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS lesson_test_json JSONB`,
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS lesson_type VARCHAR(50) DEFAULT 'theory'`,
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS source_section TEXT`,
        `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS difficulty_level VARCHAR(20) DEFAULT 'Beginner'`,
